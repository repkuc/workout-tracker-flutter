    ...
    children: [
      ...
      PopupMenuButton<String>(
        ...
        itemBuilder: (BuildContext context) => [
          const PopupMenuItem(
            value: 'ru',
            child: Row(children: [Text('🇷🇺', style: TextStyle(fontSize: 16)), SizedBox(width: 8), Text('Русский')]),
          ),
          const PopupMenuItem(
            value: 'lv',
            child: Row(children: [Text('🇱🇻', style: TextStyle(fontSize: 16)), SizedBox(width: 8), Text('Latviešu')]),
          ),
          const PopupMenuItem(
            value: 'en',
            child: Row(children: [Text('🇬🇧', style: TextStyle(fontSize: 16)), SizedBox(width: 8), Text('English')]),
          ),
          const PopupMenuDivider(),
          PopupMenuItem(
            value: 'export',
            child: Row(children: [const Icon(Icons.upload, color: Color(0xFFF97316), size: 20), const SizedBox(width: 8), Text('backup.export'.tr())]),
          ),
          PopupMenuItem(
            value: 'import',
            child: Row(children: [const Icon(Icons.download, color: Color(0xFFF97316), size: 20), const SizedBox(width: 8), Text('backup.import'.tr())]),
          ),
        ],
      ),
    ],
